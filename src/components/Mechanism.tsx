...
export default function MechanismSection() {
    ...
    return (
        <section id="mechanism" className="py-16 md:py-20 relative">
            <div className={containerClass}>
                <div className="mb-16 max-w-[1200px] mx-auto text-center">
                ...
                <div className="max-w-[1380px] mx-auto mb-10 md:mb-12">
                    <p className="text-slate-300/88 text-base md:text-lg max-w-[940px] mx-auto text-center font-medium leading-relaxed mb-6 md:mb-7">
                ...
                {/* WOW Detail Panel */}
                <div className="mb-8 md:mb-10 flex flex-col items-center gap-5 text-center">
                    <div className="w-full max-w-[1380px] px-6 md:px-10">
                        <div className="flex flex-col items-center gap-4">
                            <div className="flex items-center justify-center gap-4 text-white">
                                ...
                                <p className="text-xl md:text-[1.7rem] font-bold tracking-tight leading-snug">
                                    每天流程：按下开始 <span className="text-emerald-400 mx-2 font-black">→</span> 孩子看 5 分钟 <span className="text-emerald-400 mx-2 font-black">→</span> 结束后关机。
                                </p>
                            </div>

                            <div className="flex flex-wrap gap-2 md:gap-3 items-center justify-center">
                                <span className="flex items-center gap-2 text-[11px] md:text-xs font-bold tracking-[0.18em] text-emerald-300">
