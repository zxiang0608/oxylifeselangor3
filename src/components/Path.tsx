...
export default function PathSection() {
    ...
    return (
        <section id="path" className="relative py-16 md:py-20 bg-transparent border-y border-white/5 backdrop-blur-3xl">
            <div className={containerClass}>
                <div className="max-w-[980px] mb-14 text-center mx-auto">
                    <div className="nurture-tag text-center w-fit justify-center mx-auto mb-4 text-[10px] md:text-[11px] tracking-[0.18em] opacity-80">THE CLINICAL PROTOCOL</div>
                    ...
                    <p className="text-slate-300 font-medium text-[17px] md:text-[19px] leading-relaxed w-fit whitespace-nowrap mx-auto">
                        从评估、监测到专属方案制定，全程更清楚，也更容易坚持。
                    </p>
                </div>
