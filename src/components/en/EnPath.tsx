...
export default function PathSection() {
    ...
    const steps = [
        {
            step: "01",
            title: "Check suitability first",
            summary: "Understand your child’s current visual condition before starting.",
            relief: "No need to guess or start with blind trial and error.",
            cardClass: "border-white/8",
        },
        {
            step: "02",
            title: "Track progress clearly",
            summary: "Monitor visual changes from home with a clearer routine.",
            relief: "Notice changes earlier, instead of waiting until vision worsens.",
            cardClass: "border-white/10",
        },
        {
            step: "03",
            title: "Set a suitable plan",
            summary: "Match the routine and pace based on your child’s progress.",
            relief: "Around 5 minutes each session, practical to sustain at home.",
                ...
                <div className="max-w-[980px] mb-9 md:mb-14 text-center mx-auto">
                    ...
                    <h2 className="mb-5 text-white font-[900] tracking-tight leading-[1.08] max-w-[18.5rem] sm:max-w-[24rem] md:max-w-[900px] mx-auto">
                        ...
                        <span className="hidden md:block md:text-[3rem]">
                            <span className="block">Not a complicated process,</span>
                            <span className="block">but guided step by step with clarity.</span>
                        </span>
                    </h2>
                    <p className="text-slate-300 font-medium text-[16px] sm:text-[17px] md:text-[19px] leading-relaxed max-w-[18.5rem] sm:max-w-[24rem] md:max-w-none mx-auto">
                        From first assessment to monitoring and plan-setting,<br className="md:hidden" />
