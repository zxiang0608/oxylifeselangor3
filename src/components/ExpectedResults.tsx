...
export default function ExpectedResults() {
    ...
    return (
        <section id="expected-results" className="py-16 md:py-20 bg-[#080C14]">
            <div className={containerClass}>
                <div className="mb-18 md:mb-20">
                    <div className="mx-auto mb-6 md:mb-7 max-w-[1320px] flex flex-col items-center text-center">
                        <div className="nurture-tag mx-auto w-fit text-sm md:text-base px-4 py-1.5">真实世界的改变</div>
                        <h2 className="text-[2.2rem] md:text-[3rem] font-[900] tracking-tight mb-3 text-white text-center leading-[1.12] mt-3 whitespace-nowrap">
                            不只是稳住度数，也要把孩子的用眼状态带回来。
                        </h2>
                        <p className="text-slate-400 font-medium text-[16px] md:text-[17px] max-w-[680px] leading-relaxed mx-auto">
