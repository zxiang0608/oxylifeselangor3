...
export default function Navbar() {
    return (
        <nav className="absolute top-0 left-0 w-full z-[100] transition-all duration-300 py-1.5 md:py-3">
            ...
            <div className="max-w-[1600px] w-[92vw] md:w-[90vw] mx-auto flex items-center justify-between relative z-10 transition-transform duration-300">
                <div className="flex items-center">
                    <img src="/images/oxylife-logo-new.png" alt="Oxylife" className="h-[1.55rem] md:h-[2.25rem] w-auto object-contain transition-all duration-300" />
                </div>
                ...
                {/* CTA Button */}
                <button className="relative group text-[10px] md:text-[11px] font-[800] text-white tracking-[0.14em] md:tracking-[0.2em] bg-blue-600 px-5 md:px-8 py-2.5 md:py-3.5 rounded-full hover:bg-blue-500 transition-all cursor-pointer overflow-visible">
                    专家咨询
