    ...
    return (
        <nav className="absolute top-0 left-0 w-full z-[100] transition-all duration-300 py-2.5 md:py-3">
            ...
            <div className="max-w-[1600px] w-[94vw] md:w-[90vw] mx-auto min-h-[3.9rem] md:min-h-0 flex items-center justify-between relative z-10 transition-transform duration-300">
                ...
                {/* CTA Button */}
                <button className="relative group min-w-[7.9rem] md:min-w-0 text-[10px] md:text-[11px] font-[800] text-white tracking-[0.12em] md:tracking-[0.2em] bg-blue-600 px-4.5 md:px-8 py-2.5 md:py-3.5 rounded-full hover:bg-blue-500 transition-all cursor-pointer overflow-visible shadow-[0_10px_24px_rgba(37,99,235,0.22)]">
                    专家咨询
